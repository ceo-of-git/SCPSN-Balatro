...
SMODS.Joker {
	...
	-- Misc Options:
	atlas = 'SCPSN_Jokers_Common',		-- Atlas ID (Set at the top of the file)
	pos = { x = 4, y = 1 },		-- This card's position on the atlas, starting at {x=0,y=0} for the very top left.
...
SMODS.Joker {
	...
	-- Misc Options:
	atlas = 'SCPSN_Jokers_Common',
	pos = { x = 1, y = 2 },		-- This card's position on the atlas, starting at {x=0,y=0} for the very top left.
...
SMODS.Joker {
	...
	-- Misc Options:
	atlas = 'SCPSN_Jokers_Common',		-- Atlas ID (Set at the top of the file)
	pos = { x = 2, y = 2 },		-- This card's position on the atlas, starting at {x=0,y=0} for the very top left.
...
SMODS.Joker {
    key = 'curse_bearer',
	loc_txt = {
		name = 'The Curse Bearer',
		text = {
			"{C:mult}+16{} Mult for each Curse that you bear",
	...
	loc_vars = function(self, info_queue, card)
		G.GAME.curse_uses = G.GAME.curse_uses or 0
		local current_mult = G.GAME.curse_uses * card.ability.extra.mult_per
